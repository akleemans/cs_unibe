...
public class Bootstrap extends Job{
	...
	private void addCalendars() {
		...
		Database.addCalendar("Alinas Oktober-Testkalender","Alina");
	}
	
	private void addEvents() {
		Database.getUserByName("Bob").addEventToCalendar("Bobs Geburtstagskalender","Geburtstag Marta","08.10.2011 08:00", "08.10.2011 23:59", false);
		Database.getUserByName("Bob").addEventToCalendar("Bobs Geburtstagskalender","Geburtstag Giovanni","09.10.2011 10:00", "09.10.2011 23:59",false);
		Database.getUserByName("Bob").addEventToCalendar("Bobs Geburtstagskalender","Geburtstag Toni","11.10.2011 18:00", "11.10.2011 23:59",false);
		...
		Database.getUserByName("Alina").addEventToCalendar("Alinas Oktober-Testkalender","Event: 6. Oktober","06.10.2011 00:00", "06.10.2011 23:59",true);
		Database.getUserByName("Alina").addEventToCalendar("Alinas Oktober-Testkalender","Event: 7. Oktober","07.10.2011 00:00", "07.10.2011 23:59",true);
		Database.getUserByName("Alina").addEventToCalendar("Alinas Oktober-Testkalender","Event: 8. Oktober","08.10.2011 00:00", "08.10.2011 23:59",true);
