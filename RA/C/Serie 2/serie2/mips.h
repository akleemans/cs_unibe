...
word create_itype_hex(unsigned, unsigned, unsigned, unsigned);
word create_jtype_hex(unsigned, unsigned);
word create_rtype_hex(unsigned, unsigned, unsigned, unsigned, unsigned, unsigned);

word signExtend(halfword);
word zeroExtend(halfword);

void storeWord(word, word);
word loadWordFrom(word);

/* Function declarations for MIPS operations */
